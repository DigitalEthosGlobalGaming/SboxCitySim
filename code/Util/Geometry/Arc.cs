...
namespace GridSystem.Geometry
{
    public sealed class Arc : IPathShape, ITransformable, IInterval
    {
        ...
        public Arc(Vector2 pointA, Vector2 pointB, bool clockwise = false)
        {
            ...
            Radius = Vector2.DistanceBetween(Center, pointA);
        ...
        public static Arc FromPoints(Vector2 pointA, Vector2 pointB, Vector2 pointC)
        {
            ...
            var Radius = Vector2.DistanceBetween(Center, pointA);
        ...
        public BoundingBox BoundingBox
        {
            get
            {
                ...
                {
                    var extremePoint = GeometryUtils.Vector2Min(arcPoints[0], arcPoints[1]);
                ...
                {
                    var extremePoint = GeometryUtils.Vector2Max(arcPoints[0], arcPoints[1]);
